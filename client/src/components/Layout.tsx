                    ...
                    <div className="flex items-center gap-4 w-96">
                        <div className="relative w-full">
                            ...
                            <input
                                ...
                                className="w-full pl-10 pr-4 py-2 bg-slate-100 dark:bg-slate-800 border-none rounded-full text-sm focus:ring-2 focus:ring-indigo-500/20 focus:bg-white dark:focus:bg-slate-800 dark:text-slate-200 transition-all"
                            />
                        </div>
                    </div>
