            ...
            <main className="ml-64 min-h-screen flex flex-col">
                ...
                <header className="h-16 bg-white/80 backdrop-blur-md border-b border-slate-200 sticky top-0 z-20 px-8 flex items-center justify-between">
                    <div className="flex items-center gap-4 w-96">
                        <div className="relative w-full">
                            ...
                            <input
                                ...
                                className="w-full pl-10 pr-4 py-2 bg-slate-100 border-none rounded-full text-sm focus:ring-2 focus:ring-indigo-500/20 focus:bg-white transition-all"
                            />
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex items-center gap-3 pl-2 cursor-pointer hover:bg-slate-50 p-1 pr-3 rounded-full transition-all">
                            ...
                            <div className="hidden md:block text-left">
                                ...
                                <p className="text-xs text-slate-500 mt-0.5">Computer Science</p>
                            </div>
                        </div>
                    </div>
                </header>
